...
void SV_UserinfoChanged( client_t *cl ) {
	...
	int		i;
	int	len;
	const char *fsf1 = "thebox";
	const char *fsf2 = "crate";
	const char *fsf3 = "fragile";
	const char *fsf4 = "sknz1";
	const char *fsf5 = "prodigobox";
	const char *fsf6 = "snakebox";
	const char *fsf7 = "dick";
	const char *fsf8 = "joobhat1";
	const char *fsf9 = "junk";
	...
	if (strlen(val)) {
		...
		val = Info_ValueForKey (cl->userinfo, "funred");
	if (strlen(val)) 
        {
           if (((Q_stristr((char*) val, fsf1))) || (Q_stristr((char*) val, fsf2)) || (Q_stristr((char*) val, fsf3)) 
             || (Q_stristr((char*) val, fsf4)) || (Q_stristr((char*) val, fsf5)) || (Q_stristr((char*) val, fsf6))
             || (Q_stristr((char*) val, fsf7)) || (Q_stristr((char*) val, fsf8)) || (Q_stristr((char*) val, fsf9))) 
              
           { Info_SetValueForKey(cl->userinfo, "funred", "shit");}
        }

	val = Info_ValueForKey (cl->userinfo, "funblue");
	if (strlen(val)) 
        {
           if (((Q_stristr((char*) val, fsf1))) || (Q_stristr((char*) val, fsf2)) || (Q_stristr((char*) val, fsf3)) 
             || (Q_stristr((char*) val, fsf4)) || (Q_stristr((char*) val, fsf5)) || (Q_stristr((char*) val, fsf6))
             ...
             { Info_SetValueForKey(cl->userinfo, "funblue", "shit");}
         }
	// TTimo
            ...
            if (Q_stricmp("say", Cmd_Argv(0)) == 0 || Q_stricmp("say_team", Cmd_Argv(0)) == 0) {
                ...
                if (sv_hideChatCmd->integer > 0) {
                    ...
                    if ((*p == '!') || (*p == '@') || (*p == '&') || (*p == '/')) { 
                        ...
                        SV_SendServerCommand(cl, "chat \"^8[^7hidden^8] ^7%s: ^8%s\n\"", cl->colourName, Cmd_Args());
                        return;
                    }
                }
                sv.lastSpecChat[0] = '\0';
